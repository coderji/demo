...
public class SensorFragment extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.sensor_register).setOnClickListener((v) ->
                mSensorManager.registerListener(mSensorEventListener, mSensorManager.getDefaultSensor(Sensor.TYPE_PROXIMITY), SensorManager.SENSOR_DELAY_NORMAL, new Handler()));
        view.findViewById(R.id.sensor_unregister).setOnClickListener((v) ->
